...
#
"""Module that is used to start the User PyMOL."""
import zmq
...
def main():
    try:
        ...
        main_socket.bind("tcp://127.0.0.1:9070")  # Binding to localhost on port 7070
    ...
    while True:
        ...
        try:
            ...
            print(data)
            if data["action"] == "load_pymol_session":
                cmd.load(data["data"])
                main_socket.send_string("PyMOL command finished.")
