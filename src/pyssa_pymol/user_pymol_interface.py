...
class UserPyMOLInterface(QtCore.QObject):
  ...
  def _run_command_in_main_thread(self, the_command_info: tuple) -> None:
    ...
    if tmp_command_name == pymol_enums.CommandEnum.REINITIALIZE_SESSION.value:
      ...
      logger.info("Running command: get_all_object_names")
      tmp_result: tuple[bool, str, Optional[list]] = (
          commands.get_all_object_names()
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {
              "success": tmp_result[0],
              "message": str(tmp_result[1]),
              "data": tmp_result[2],
          },
      )
      ...
      tmp_result: tuple[bool, str] = commands.set_custom_setting(
          tmp_setting_name, tmp_value
      )
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
      )
      ...
      logger.info("Running command: get_residue_colors")
      _, tmp_selection_string = tmp_args
      tmp_result: tuple[bool, str, Optional[dict]] = (
          commands.get_residue_colors(tmp_selection_string)
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {
      ...
      tmp_result: tuple[bool, str, Optional[tuple]] = commands.get_chain_color(
          tmp_selection_string, tmp_chain_letter
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {
            ...
            tmp_command_name
            == pymol_enums.CommandEnum.GET_RESIDUE_COLOR_CONFIG.value
    ):
      logger.info("Running command: get_residue_color_config")
      tmp_selection_string, tmp_chain_letter = tmp_args
      tmp_result: tuple[bool, str, Optional[list]] = (
          commands.get_residue_color_config(
              tmp_selection_string, tmp_chain_letter
          )
      )
      self._sender_socket.send_json(
      ...
      tmp_selection_string, tmp_chain_letter = tmp_args
      tmp_result: tuple[bool, str, Optional[dict]] = (
          commands.get_chain_repr_state(tmp_selection_string, tmp_chain_letter)
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {
            ...
            tmp_command_name
            == pymol_enums.CommandEnum.SHOW_CUSTOM_REPRESENTATION.value
    ):
      logger.info("Running command: show_custom_representation")
      tmp_representation, tmp_selection_string = tmp_args
      tmp_result: tuple[bool, str] = commands.show_custom_representation(
          tmp_representation, tmp_selection_string
      )
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
      )
            ...
            tmp_command_name
            == pymol_enums.CommandEnum.HIDE_CUSTOM_REPRESENTATION.value
    ):
      logger.info("Running command: hide_custom_representation")
      tmp_representation, tmp_selection_string = tmp_args
      tmp_result: tuple[bool, str] = commands.hide_custom_representation(
          tmp_representation, tmp_selection_string
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
            ...
            tmp_command_name
            == pymol_enums.CommandEnum.ZOOM_WITH_CUSTOM_PARAMETERS.value
    ):
      logger.info("Running command: zoom_with_custom_parameters")
      tmp_selection_string, tmp_buffer_size, tmp_state, tmp_complete_flag = (
          tmp_args
      ...
      tmp_result: tuple[bool, str] = commands.color_selection(
          tmp_pymol_color, tmp_selection_string
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
      ...
      tmp_result: tuple[bool, str] = commands.set_background_color(
          tmp_pymol_color
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
            ...
            tmp_command_name
            == pymol_enums.CommandEnum.SET_DEFAULT_GRAPHIC_SETTINGS.value
    ):
      logger.info("Running command: set_default_graphic_settings")
      tmp_result: tuple[bool, str] = commands.set_default_graphics_settings()
      logger.info(f"Command result: {tmp_result}")
      ...
      tmp_result: tuple[bool, str] = commands.ray(
          tmp_width, tmp_height, tmp_renderer
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
      ...
      tmp_result: tuple[bool, str] = commands.draw(
          tmp_width, tmp_height, tmp_antialias_value
      )
      logger.info(f"Command result: {tmp_result}")
      self._sender_socket.send_json(
          {"success": tmp_result[0], "message": str(tmp_result[1])},
