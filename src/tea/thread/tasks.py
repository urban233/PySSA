...
class _LegacyAction(QtCore.QObject):
  ...
  def __init__(self, target, args=()) -> None:  # noqa: ANN101
    """Constructor.
  ...
  def run_action(self) -> None:  # noqa: ANN101
    """Runs the function."""
...
class LegacyTask:
  ...
  def __init__(self, target, args=(), post_func=None) -> None:  # noqa: ANN101
    """Constructor.
  ...
  def is_finished(self) -> bool:  # noqa: ANN101
