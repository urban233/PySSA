...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.project_tab)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_3.addWidget(self.label_3)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.txt_workspace_dir = QtWidgets.QLineEdit(parent=self.project_tab)
        self.txt_workspace_dir.setObjectName("txt_workspace_dir")
        self.horizontalLayout_4.addWidget(self.txt_workspace_dir)
        self.btn_workspace_dir = QtWidgets.QToolButton(parent=self.project_tab)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.analysis_tab)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_4.addWidget(self.label_6)
        self.line = QtWidgets.QFrame(parent=self.analysis_tab)
        ...
        self.label_4 = QtWidgets.QLabel(parent=self.analysis_tab)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_5.addWidget(self.label_4)
        self.spb_cycles = QtWidgets.QSpinBox(parent=self.analysis_tab)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.analysis_tab)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_6.addWidget(self.label_5)
        self.dspb_cutoff = QtWidgets.QDoubleSpinBox(parent=self.analysis_tab)
        ...
        self.label = QtWidgets.QLabel(parent=self.image_tab)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.line_2 = QtWidgets.QFrame(parent=self.image_tab)
        ...
        self.label_24 = QtWidgets.QLabel(parent=self.image_tab)
        self.label_24.setObjectName("label_24")
        self.horizontalLayout_2.addWidget(self.label_24)
        self.box_bg_color = QtWidgets.QComboBox(parent=self.image_tab)
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.image_tab)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_7.addWidget(self.label_8)
        self.box_renderer = QtWidgets.QComboBox(parent=self.image_tab)
        ...
        self.label_10 = QtWidgets.QLabel(parent=self.image_tab)
        self.label_10.setObjectName("label_10")
        self.horizontalLayout_8.addWidget(self.label_10)
        self.box_ray_trace_mode = QtWidgets.QComboBox(parent=self.image_tab)
        ...
        self.label_14 = QtWidgets.QLabel(parent=self.image_tab)
        self.label_14.setObjectName("label_14")
        self.horizontalLayout_9.addWidget(self.label_14)
        self.box_ray_texture = QtWidgets.QComboBox(parent=self.image_tab)
        ...
        self.cb_toggle_pymol_expert_mode = QtWidgets.QCheckBox(parent=self.tab)
        self.cb_toggle_pymol_expert_mode.setObjectName("cb_toggle_pymol_expert_mode")
        self.verticalLayout_10.addWidget(self.cb_toggle_pymol_expert_mode)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(148, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cb_toggle_pymol_expert_mode.setText(_translate("Dialog", "Enable PyMOL expert mode (resets every program launch)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Dialog", "PyMOL"))
