...
class Ui_Dialog(object):
  ...
  def retranslateUi(self, Dialog):
    ...
    self.tabWidget.setTabText(
        self.tabWidget.indexOf(self.project_tab),
        _translate("Dialog", "Project"),
    )
    ...
    self.tabWidget.setTabText(
        self.tabWidget.indexOf(self.analysis_tab),
    ...
    self.tabWidget.setTabText(
        self.tabWidget.indexOf(self.image_tab), _translate("Dialog", "Image")
    )
