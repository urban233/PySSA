...
class Ui_Dialog(object):
  ...
  def setupUi(self, Dialog):
    ...
    self.btn_pred_analysis_mono_seq_to_predict = QtWidgets.QPushButton(
        self.frame
    )
    ...
    self.lbl_pred_analysis_mono_to_analysis_setup = QtWidgets.QLabel(
        self.frame_bottom
    )
    ...
    self.box_pred_analysis_mono_prot_struct_1 = QtWidgets.QComboBox(
        self.frame_2
    )
    ...
    self.box_pred_analysis_mono_prot_struct_2 = QtWidgets.QComboBox(
        self.frame_2
    )
    ...
    self.list_pred_analysis_mono_ref_chains = QtWidgets.QListWidget(
        self.frame_2
    )
    ...
    self.btn_pred_analysis_mono_start = QtWidgets.QPushButton(
        self.frame_bottom_2
    )
  ...
  def retranslateUi(self, Dialog):
    ...
    self.tabWidget.setTabText(
        self.tabWidget.indexOf(self.tab), _translate("Dialog", "Prediction")
    )
    ...
    self.tabWidget.setTabText(
        self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "Analysis")
    )
