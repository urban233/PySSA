# Form implementation generated from reading ui file 'src/pyssa/gui/ui/forms/dlgSettingsGlobal.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame_settings_general = QtWidgets.QFrame(parent=self.frame)
        self.frame_settings_general.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_settings_general.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.frame_settings_general)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_3.addWidget(self.label_3)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.txt_workspace_dir = QtWidgets.QLineEdit(parent=self.frame_settings_general)
        self.txt_workspace_dir.setObjectName("txt_workspace_dir")
        self.horizontalLayout_4.addWidget(self.txt_workspace_dir)
        self.btn_workspace_dir = QtWidgets.QToolButton(parent=self.frame_settings_general)
        ...
        self.check_box_start_help = QtWidgets.QCheckBox(parent=self.frame_settings_general)
        ...
        self.frame_settings_distance_parameters = QtWidgets.QFrame(parent=self.frame)
        self.frame_settings_distance_parameters.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_settings_distance_parameters.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.label_6 = QtWidgets.QLabel(parent=self.frame_settings_distance_parameters)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_4.addWidget(self.label_6)
        self.verticalLayout_6.addLayout(self.verticalLayout_4)
        self.line = QtWidgets.QFrame(parent=self.frame_settings_distance_parameters)
        ...
        self.label_4 = QtWidgets.QLabel(parent=self.frame_settings_distance_parameters)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_5.addWidget(self.label_4)
        self.spb_cycles = QtWidgets.QSpinBox(parent=self.frame_settings_distance_parameters)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.frame_settings_distance_parameters)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_6.addWidget(self.label_5)
        self.dspb_cutoff = QtWidgets.QDoubleSpinBox(parent=self.frame_settings_distance_parameters)
        ...
        self.frame_settings_image_parameters = QtWidgets.QFrame(parent=self.frame)
        self.frame_settings_image_parameters.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_settings_image_parameters.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.label = QtWidgets.QLabel(parent=self.frame_settings_image_parameters)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.line_2 = QtWidgets.QFrame(parent=self.frame_settings_image_parameters)
        ...
        self.label_24 = QtWidgets.QLabel(parent=self.frame_settings_image_parameters)
        self.label_24.setObjectName("label_24")
        self.horizontalLayout_2.addWidget(self.label_24)
        self.box_bg_color = QtWidgets.QComboBox(parent=self.frame_settings_image_parameters)
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.frame_settings_image_parameters)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_7.addWidget(self.label_8)
        self.box_renderer = QtWidgets.QComboBox(parent=self.frame_settings_image_parameters)
        ...
        self.label_10 = QtWidgets.QLabel(parent=self.frame_settings_image_parameters)
        self.label_10.setObjectName("label_10")
        self.horizontalLayout_8.addWidget(self.label_10)
        self.box_ray_trace_mode = QtWidgets.QComboBox(parent=self.frame_settings_image_parameters)
        ...
        self.label_14 = QtWidgets.QLabel(parent=self.frame_settings_image_parameters)
        self.label_14.setObjectName("label_14")
        self.horizontalLayout_9.addWidget(self.label_14)
        self.box_ray_texture = QtWidgets.QComboBox(parent=self.frame_settings_image_parameters)
        ...
        self.lbl_color_vision_mode = QtWidgets.QLabel(parent=self.frame)
        self.lbl_color_vision_mode.setObjectName("lbl_color_vision_mode")
        self.horizontalLayout.addWidget(self.lbl_color_vision_mode)
        self.cb_color_vision_mode = QtWidgets.QComboBox(parent=self.frame)
        ...
        self.btn_ok = QtWidgets.QPushButton(parent=self.frame_bottom)
