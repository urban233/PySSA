# Form implementation generated from reading ui file 'src/pyssa/gui/ui/forms/dlgWarningPredictionZip.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 36, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_2.addItem(spacerItem1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.btnRunNewPrediction = QtWidgets.QPushButton(parent=Dialog)
        self.btnRunNewPrediction.setObjectName("btnRunNewPrediction")
        self.horizontalLayout.addWidget(self.btnRunNewPrediction)
        self.btnRunAnalysis = QtWidgets.QPushButton(parent=Dialog)
