# Form implementation generated from reading ui file 'src/pyssa/gui/ui/forms/predict_protein_view.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tab_widget = QtWidgets.QTabWidget(parent=Dialog)
        ...
        self.frame = QtWidgets.QFrame(parent=self.tab_prediction)
        ...
        self.lbl_proteins_to_predict = QtWidgets.QLabel(parent=self.frame)
        ...
        self.table_proteins_to_predict = QtWidgets.QTableWidget(parent=self.frame)
        ...
        self.btn_prediction_remove = QtWidgets.QPushButton(parent=self.frame)
        ...
        self.lbl_advanced_config = QtWidgets.QLabel(parent=self.frame)
        ...
        self.btn_edit_advanced_config = QtWidgets.QPushButton(parent=self.frame)
        ...
        self.frame_bottom = QtWidgets.QFrame(parent=self.tab_prediction)
        ...
        self.lbl_go_to_analysis_setup = QtWidgets.QLabel(parent=self.frame_bottom)
        ...
        self.btn_go_to_analysis_setup = QtWidgets.QPushButton(parent=self.frame_bottom)
        ...
        self.frame_3 = QtWidgets.QFrame(parent=self.tab_analysis)
        ...
        self.lbl_analysis_overview = QtWidgets.QLabel(parent=self.frame_3)
        ...
        self.list_analysis_overview = QtWidgets.QListWidget(parent=self.frame_3)
        ...
        self.btn_analysis_remove = QtWidgets.QPushButton(parent=self.frame_3)
        self.btn_analysis_remove.setObjectName("btn_analysis_remove")
        self.horizontalLayout_116.addWidget(self.btn_analysis_remove)
        self.btn_analysis_add = QtWidgets.QPushButton(parent=self.frame_3)
        ...
        self.frame_bottom_2 = QtWidgets.QFrame(parent=self.tab_analysis)
        ...
        self.btn_analysis_back_4 = QtWidgets.QPushButton(parent=self.frame_bottom_2)
        self.btn_analysis_back_4.setObjectName("btn_analysis_back_4")
        self.horizontalLayout_2.addWidget(self.btn_analysis_back_4)
        self.btn_start_prediction_analysis = QtWidgets.QPushButton(parent=self.frame_bottom_2)
