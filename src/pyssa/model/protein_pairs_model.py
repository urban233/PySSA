...
class ProteinPairsModel(QtGui.QStandardItemModel):
  ...
  def build_model_from_scratch(
    ...
    for tmp_protein_pair in the_protein_pair_objects:
      ...
      tmp_protein_pair_item.setData(
          tmp_protein_pair, enums.ModelEnum.OBJECT_ROLE
      )
      ...
      tmp_protein_item_1 = QtGui.QStandardItem(
          tmp_protein_pair.protein_1.get_molecule_object()
      )
      tmp_protein_item_1.setData(
          tmp_protein_pair.protein_1, enums.ModelEnum.OBJECT_ROLE
      )
      ...
      tmp_protein_item_2 = QtGui.QStandardItem(
          tmp_protein_pair.protein_2.get_molecule_object()
      )
      tmp_protein_item_2.setData(
          tmp_protein_pair.protein_2, enums.ModelEnum.OBJECT_ROLE
      )
  ...
  def check_if_scratch_scene_exists(
    ...
    # on chain node
      ...
      tmp_scenes_header_item = (
          self.itemFromIndex(a_model_index)
          .parent()
          .parent()
          .parent()
          .child(0, 0)
  ...
  def add_protein_pair(
    ...
    tmp_protein_item_1.setData(
        a_protein_pair.protein_1, enums.ModelEnum.OBJECT_ROLE
    )
    tmp_protein_item_1.setData("protein", enums.ModelEnum.TYPE_ROLE)
    tmp_chains_item_1 = QtGui.QStandardItem("Chains")
    tmp_chains_item_1.setData("header", enums.ModelEnum.TYPE_ROLE)
    ...
    tmp_protein_item_2.setData(
        a_protein_pair.protein_2, enums.ModelEnum.OBJECT_ROLE
    )
    tmp_protein_item_2.setData("protein", enums.ModelEnum.TYPE_ROLE)
    tmp_chains_item_2 = QtGui.QStandardItem("Chains")
    tmp_chains_item_2.setData("header", enums.ModelEnum.TYPE_ROLE)
