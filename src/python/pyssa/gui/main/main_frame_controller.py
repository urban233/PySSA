...
from pyssa.gui.components import import_ligand_component
...
class MainFrameController:
  ...
  def __init__(self, a_main_frame: "main_frame.MainFrame") -> None:
    ...
    self.component_manager = component_manager.ComponentManager(
      {
        model_definitions.ComponentsEnum.OPEN_PROJECT: open_project_component.OpenProjectComponent(
          self.schedule_tool_task_result_object),
        model_definitions.ComponentsEnum.CREATE_PROJECT: create_project_component.CreateProjectComponent(
          self.schedule_tool_task_result_object),
    ...
    self.project_model: "project_model.ProjectModel" = project_model.ProjectModel.from_workspace_path(
      model_definitions.ModelDefinitions.DEFAULT_WORKSPACE_PATH, project_model.ProjectModel.dummy_method
    )
  ...
  # <editor-fold desc="Application management">
  ...
  def update_main_frame_gui(self) -> None:
    ...
    if self.project is None:
      ...
      # A project is open
      self.main_frame.setWindowTitle(f"PySSA - {self.project.name}")
  ...
  def stop_wait_cursor(self) -> None:
    ...
    self.main_frame.enable_job_panels()
