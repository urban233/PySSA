...
from sandbox.chimerax_adapter import command_exec
#from src.pyssa.gui.ui.custom_widgets import custom_line_edit, toggle_button, color_grid
from sandbox.gui.forms.auto import auto_pyqt6_main_view
...
class MainView(QtWidgets.QMainWindow):
  ...
  def __init__(self, a_process) -> None:
    """Constructor."""
    super().__init__()
    # build ui object
    self.ui = auto_pyqt6_main_view.Ui_MainWindow()
  ...
  def connect_signals(self):
    self.ui.action_open_project.triggered.connect(self.run_action)

  def run_action(self):
    print("Creating command_exec.ChimeraXCommandExec() object ...")
    tmp_command_exec = command_exec.ChimeraXCommandExec()
    print("Running single command")
    tmp_command_exec.run_single_command()
