...
1. Download the _PySSA_1.4.0_Setup.zip_. Click [here](https://zenodo.org/records/19358045/files/PySSA_1.4.1_Setup.zip?download=1) 
...
In the new window double-click on the file **PySSA_1.4.0._Setup.exe** to start the setup.
    <figure markdown="span">
