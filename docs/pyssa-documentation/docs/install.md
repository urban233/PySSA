...
1. Download the _PySSA_1.0.8_Setup.zip_. Click [here](https://zenodo.org/records/15564925/files/PySSA_1.0.8_Setup.zip?download=1) 
...
In the new window double-click on the file **PySSA_1.0.8._Setup.exe** to start the setup.
    <figure markdown="span">
