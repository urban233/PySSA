...
path_list = [
    ...
    # TODO: needs to be updated with the correct name
    f"C:\\ProgramData\\pyssa\\plugin\\Miniconda3\\envs\\pyssa_colab\\Lib\\site-packages\\pymol\\pymol_path\\data\\startup\\tmpPySSA",
]
styles_path_list = [
