...
#
"""Module for the predict multimer view."""
from PyQt5.QtCore import pyqtSignal
from PyQt5 import QtCore
from PyQt5 import QtGui
from PyQt5 import QtWidgets
from pyssa.gui.ui import icon_resources  # this import is used for the icons! DO NOT DELETE THIS
from pyssa.gui.ui.forms.auto_generated import auto_predict_multimer_view
from pyssa.gui.ui.styles import styles
from pyssa.util import constants


class PredictMultimerView(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None) -> None:  # noqa: ANN001
        ...
        # build ui object
        self.ui = auto_predict_multimer_view.Ui_Dialog()
    ...
    def _initialize_ui(self) -> None:
        ...
        styles.color_bottom_frame_button(self.ui.btn_pred_analysis_multi_start)
        styles.color_bottom_frame_button(self.ui.btn_pred_analysis_multi_go_analysis_setup)
        ...
        self.setWindowTitle("Prediction Multimer")
