...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_analysis_protein_struct_1 = QtWidgets.QLabel(self.frame_3)
        self.lbl_analysis_protein_struct_1.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_analysis_protein_struct_1.setObjectName("lbl_analysis_protein_struct_1")
        self.verticalLayout_132.addWidget(self.lbl_analysis_protein_struct_1)
        self.box_analysis_protein_struct_1 = QtWidgets.QComboBox(self.frame_3)
        self.box_analysis_protein_struct_1.setObjectName("box_analysis_protein_struct_1")
        self.verticalLayout_132.addWidget(self.box_analysis_protein_struct_1)
        ...
        self.lbl_analysis_protein_struct_2 = QtWidgets.QLabel(self.frame_3)
        self.lbl_analysis_protein_struct_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_analysis_protein_struct_2.setObjectName("lbl_analysis_protein_struct_2")
        self.verticalLayout_133.addWidget(self.lbl_analysis_protein_struct_2)
        self.box_analysis_protein_struct_2 = QtWidgets.QComboBox(self.frame_3)
        self.box_analysis_protein_struct_2.setObjectName("box_analysis_protein_struct_2")
        self.verticalLayout_133.addWidget(self.box_analysis_protein_struct_2)
        ...
        self.horizontalLayout_113.addItem(spacerItem5)
        self.btn_analysis_back = QtWidgets.QPushButton(self.frame_3)
        self.btn_analysis_back.setObjectName("btn_analysis_back")
        self.horizontalLayout_113.addWidget(self.btn_analysis_back)
        self.btn_analysis_next = QtWidgets.QPushButton(self.frame_3)
        self.btn_analysis_next.setObjectName("btn_analysis_next")
        self.horizontalLayout_113.addWidget(self.btn_analysis_next)
        ...
        self.lbl_analysis_protein_1_chains = QtWidgets.QLabel(self.frame_3)
        self.lbl_analysis_protein_1_chains.setObjectName("lbl_analysis_protein_1_chains")
        self.verticalLayout_134.addWidget(self.lbl_analysis_protein_1_chains)
        self.list_analysis_protein_1_chains = QtWidgets.QListWidget(self.frame_3)
        self.list_analysis_protein_1_chains.setMinimumSize(QtCore.QSize(0, 0))
        self.list_analysis_protein_1_chains.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.list_analysis_protein_1_chains.setObjectName("list_analysis_protein_1_chains")
        self.verticalLayout_134.addWidget(self.list_analysis_protein_1_chains)
        ...
        self.horizontalLayout_114.addItem(spacerItem6)
        self.btn_analysis_back_2 = QtWidgets.QPushButton(self.frame_3)
        self.btn_analysis_back_2.setObjectName("btn_analysis_back_2")
        self.horizontalLayout_114.addWidget(self.btn_analysis_back_2)
        self.btn_analysis_next_2 = QtWidgets.QPushButton(self.frame_3)
        self.btn_analysis_next_2.setObjectName("btn_analysis_next_2")
        self.horizontalLayout_114.addWidget(self.btn_analysis_next_2)
        ...
        self.lbl_analysis_protein_2_chains = QtWidgets.QLabel(self.frame_3)
        self.lbl_analysis_protein_2_chains.setObjectName("lbl_analysis_protein_2_chains")
        self.verticalLayout_130.addWidget(self.lbl_analysis_protein_2_chains)
        self.list_analysis_protein_2_chains = QtWidgets.QListWidget(self.frame_3)
        self.list_analysis_protein_2_chains.setMinimumSize(QtCore.QSize(0, 0))
        self.list_analysis_protein_2_chains.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.list_analysis_protein_2_chains.setObjectName("list_analysis_protein_2_chains")
        self.verticalLayout_130.addWidget(self.list_analysis_protein_2_chains)
        ...
        self.horizontalLayout_115.addItem(spacerItem7)
        self.btn_analysis_back_3 = QtWidgets.QPushButton(self.frame_3)
        self.btn_analysis_back_3.setObjectName("btn_analysis_back_3")
        self.horizontalLayout_115.addWidget(self.btn_analysis_back_3)
        self.btn_analysis_next_3 = QtWidgets.QPushButton(self.frame_3)
        self.btn_analysis_next_3.setObjectName("btn_analysis_next_3")
        self.horizontalLayout_115.addWidget(self.btn_analysis_next_3)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_analysis_protein_struct_1.setText(_translate("Dialog", "Protein structure 1"))
        self.lbl_analysis_batch_vs_3.setText(_translate("Dialog", "vs."))
        self.lbl_analysis_protein_struct_2.setText(_translate("Dialog", "Protein structure 2"))
        self.btn_analysis_back.setText(_translate("Dialog", "Back"))
        self.btn_analysis_next.setText(_translate("Dialog", "Next"))
        self.lbl_analysis_protein_1_chains.setText(_translate("Dialog", "Select chains in protein structure 1"))
        self.btn_analysis_back_2.setText(_translate("Dialog", "Back"))
        self.btn_analysis_next_2.setText(_translate("Dialog", "Next"))
        self.lbl_analysis_protein_2_chains.setText(_translate("Dialog", "Select chains in protein structure 2"))
        self.btn_analysis_back_3.setText(_translate("Dialog", "Back"))
        self.btn_analysis_next_3.setText(_translate("Dialog", "Next"))
