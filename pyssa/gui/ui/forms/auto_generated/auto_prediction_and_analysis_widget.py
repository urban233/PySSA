...
class Ui_Form(object):
  ...
  def setupUi(self, Form):
    ...
    self.txt_prediction_project_name.setObjectName(
        "txt_prediction_project_name"
    )
    ...
    self.txt_prediction_load_reference.setObjectName(
        "txt_prediction_load_reference"
    )
    ...
    self.btn_prediction_load_reference.setObjectName(
        "btn_prediction_load_reference"
    )
    ...
    spacerItem = QtWidgets.QSpacerItem(
        20, 235, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding
    )
  ...
  def retranslateUi(self, Form):
    ...
    self.label_15.setText(
        _translate("Form", "Choose a .pdb file or enter a PDB ID:")
    )
    self.btn_prediction_load_reference.setText(_translate("Form", "..."))
    self.cb_prediction_chain_info.setText(
        _translate("Form", "Add chain information")
    )
    self.label_16.setText(
        _translate("Form", "Chains in reference (input style: G,H)")
    )
    self.label_17.setText(
        _translate("Form", "Chains in models (input style: A,B)")
    )
    self.btn_prediction_cancel.setText(_translate("Form", "Cancel"))
    self.btn_prediction_start.setText(
        _translate("Form", "Predict with Colab Notebook")
    )
