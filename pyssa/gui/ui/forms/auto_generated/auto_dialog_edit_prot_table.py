...
class Ui_Dialog(object):
  ...
  def setupUi(self, Dialog):
    ...
    self.lbl_edit_prot_table_protein_name.setObjectName(
        "lbl_edit_prot_table_protein_name"
    )
    ...
    self.txt_edit_prot_table_protein_name.setObjectName(
        "txt_edit_prot_table_protein_name"
    )
    ...
    self.lbl_edit_prot_table_status_protein_name.setObjectName(
        "lbl_edit_prot_table_status_protein_name"
    )
    ...
    self.lbl_edit_prot_table_status_chain.setObjectName(
        "lbl_edit_prot_table_status_chain"
    )
    ...
    self.lbl_edit_prot_table_status_seq.setObjectName(
        "lbl_edit_prot_table_status_seq"
    )
  ...
  def retranslateUi(self, Dialog):
    ...
    self.lbl_edit_prot_table_protein_name.setText(
        _translate("Dialog", "Protein name")
    )
    self.lbl_edit_prot_table_status_protein_name.setText(
        _translate("Dialog", "TextLabel")
    )
    self.lbl_edit_prot_table_chain.setText(_translate("Dialog", "Chain"))
    self.lbl_edit_prot_table_status_chain.setText(
        _translate("Dialog", "TextLabel")
    )
    self.lbl_edit_prot_table_seq.setText(_translate("Dialog", "Sequence"))
    self.lbl_edit_prot_table_status_seq.setText(
        _translate("Dialog", "TextLabel")
    )
