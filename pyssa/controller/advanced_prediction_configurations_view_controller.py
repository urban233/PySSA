...
from pyssa.util import constants, gui_utils, exception
...
class AdvancedPredictionConfigurationsViewController(QtCore.QObject):
    ...
    def __init__(self, the_interface_manager: "interface_manager.InterfaceManager", a_prediction_configuration) -> None:
        """Constructor.
