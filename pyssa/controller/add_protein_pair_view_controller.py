...
class AddProteinPairViewController(QtCore.QObject):
    ...
    def __init__(self,
                 ...
                 a_list_of_extra_proteins: list[protein.Protein] = None) -> None:
        """Constructor.
        ...
        if the_existing_analysis_runs is None:
            ...
            raise exception.IllegalArgumentError("the_existing_analysis_runs is None.")
    ...
    def _add_additional_proteins_to_model(self, a_list_of_extra_proteins: list) -> None:
    ...
    def _get_protein_name_and_chains(self, the_selected_indexes: list) -> tuple[str, list]:
    ...
    def __slot_handle_selection_change_for_tree_prot_1(self, selected: QtCore.QItemSelection, deselected: QtCore.QItemSelection) -> None:
    ...
    def __slot_handle_selection_change_for_tree_prot_2(self, selected: QtCore.QItemSelection, deselected: QtCore.QItemSelection) -> None:
    ...
    def __slot_collapse_all_tree_prot_1(self, the_selected_index: QtCore.QModelIndex) -> None:
    ...
    def __slot_collapse_all_tree_prot_2(self, the_selected_index: QtCore.QModelIndex) -> None:
