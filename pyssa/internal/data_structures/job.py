...
from pyssa.util import enums, exception, analysis_util
...
class PredictionAndDistanceAnalysisJob(Job):
    ...
    def __init__(self,
                 ...
                 a_distance_analysis_job: "DistanceAnalysisJob") -> None:
        """Constructor.
...
class RayTracingJob(Job):
    ...
    def __init__(self,
        ...
        if the_destination_image_filepath is None:
            ...
            raise exception.IllegalArgumentError("the_destination_image_filepath is None.")
        if the_cached_session_filepath is None:
            logger.error("the_cached_session_filepath is None.")
            raise exception.IllegalArgumentError("the_cached_session_filepath is None.")
...
class DistanceAnalysisJobDescription:
    ...
    def __init__(self,
        ...
        if a_protein_1_pdb_cache_filepath is None:
            ...
            raise exception.IllegalArgumentError("a_protein_1_pdb_cache_filepath is None.")
        if a_protein_2_pdb_cache_filepath is None:
            logger.error("a_protein_2_pdb_cache_filepath is None.")
            raise exception.IllegalArgumentError("a_protein_2_pdb_cache_filepath is None.")
        if a_protein_1_pymol_selection_string is None:
            logger.error("a_protein_1_pymol_selection_string is None.")
            raise exception.IllegalArgumentError("a_protein_1_pymol_selection_string is None.")
        if a_protein_2_pymol_selection_string is None:
            logger.error("a_protein_2_pymol_selection_string is None.")
            raise exception.IllegalArgumentError("a_protein_2_pymol_selection_string is None.")
        if a_cutoff is None:
            logger.error("a_cutoff is None.")
            raise exception.IllegalArgumentError("a_cutoff is None.")
...
class RayTracingJobDescription:
    ...
    def __init__(self,
        ...
        if a_destination_image_filepath is None:
            ...
            raise exception.IllegalArgumentError("a_destination_image_filepath is None.")
...
class GeneralPurposeJobDescription:
    ...
    def __init__(self, a_job_short_description: "enums.JobShortDescription") -> None:
        """Constructor.
