...
class Project:
    ...
    def set_id(self, an_id: int) -> None:
        ...
        if an_id is None or an_id < 0:
            ...
            raise exception.IllegalArgumentError("an_id is either None or a value less than 0.")
    ...
    def is_sequence_as_protein_in_project(self, a_sequence_name: str) -> bool:
        ...
        if a_sequence_name is None or a_sequence_name == "":
            ...
            raise exception.IllegalArgumentError("a_sequence_name is either None or an empty string.")
    ...
    def search_protein_pair(self, a_protein_pair_name: str) -> Optional["protein_pair.ProteinPair"]:
        ...
        if a_protein_pair_name is None or a_protein_pair_name == "":
            ...
            raise exception.IllegalArgumentError("a_protein_pair_name is either None or an empty string.")
    ...
    def search_sequence(self, a_seq_name: str) -> Optional[SeqRecord.SeqRecord]:
        ...
        if a_seq_name is None or a_seq_name == "":
            ...
            raise exception.IllegalArgumentError("a_seq_name is either None or an empty string.")
