...
class Chain:
    ...
    def set_id(self, value: int) -> None:
        ...
        if value is None or value < 0:
            ...
            raise exception.IllegalArgumentError("value is either None or a negative integer.")
        
        # </editor-fold>
        
        self._id = value

    def get_color(self, a_selection_string: str, the_pymol_session_manager: "pymol_session_manager.PymolSessionManager") -> tuple[str, bool]:
