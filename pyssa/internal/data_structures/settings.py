...
class Settings:
    ...
    def _check_integrity_of_color_blindness_value(a_color_blindness_value: str) -> str:
        ...
        if a_color_blindness_value is None or a_color_blindness_value == "":
            ...
            raise exception.IllegalArgumentError("a_color_blindness_value is either None or an empty string.")
    ...
    def _check_integrity_of_ray_texture_value(a_ray_texture_value: int) -> int:
        ...
        raise ValueError(f"Invalid ray trace mode! The value is not between 0 and 5: {a_ray_texture_value}")
    ...
    def _check_integrity_of_start_help_at_startup_flag(start_help_at_startup_flag: int) -> int:
        ...
        if start_help_at_startup_flag is None:
            ...
            raise exception.IllegalArgumentError("start_help_at_startup_flag is None.")
    ...
    def _check_integrity_of_proteins_tab_use_toggle_flag(proteins_tab_use_toggle_flag: int) -> int:
        ...
        if proteins_tab_use_toggle_flag is None:
            ...
            raise exception.IllegalArgumentError("proteins_tab_use_toggle_flag is None.")
    ...
    def _check_integrity_of_proteins_tab_use_combobox_for_colors_flag(proteins_tab_use_combobox_for_colors_flag: int) -> int:
        ...
        if proteins_tab_use_combobox_for_colors_flag is None:
            ...
            raise exception.IllegalArgumentError("proteins_tab_use_combobox_for_colors_flag is None.")
