...
def get_protein_chains(a_pdb_filepath: str, the_main_socket: zmq.Socket, a_socket: zmq.Socket) -> list["chain.Chain"]:
    ...
    if a_pdb_filepath is None or a_pdb_filepath == "":
        ...
        raise exception.IllegalArgumentError("a_pdb_filepath is either None or an empty string.")
...
def get_chain_letter_of_first_protein_sequence(chains: list["chain.Chain"]) -> str:
