...
def preview_image(the_pymol_session_manager: "pymol_session_manager.PymolSessionManager", a_placeholder_2: int) -> tuple[int, str]:
...
def create_drawn_image(an_image_filepath: str, the_pymol_session_manager: "pymol_session_manager.PymolSessionManager") -> tuple[int, str]:
