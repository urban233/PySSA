...
class DistanceAnalysis:
    ...
    def __init__(
        ...
        if a_cutoff is None or a_cutoff < 0:
            ...
            raise exception.IllegalArgumentError("a_cutoff is either None or a negative value.")
        if cycles is None or cycles < 0:
            logger.error("cycles is either None or a negative value.")
            raise exception.IllegalArgumentError("cycles is either None or a negative value.")
    ...
    def create_align_selections(
        ...
        if protein_1_selection is None or protein_1_selection == "":
            ...
            raise exception.IllegalArgumentError("protein_1_selection is either None or an empty string.")
        if protein_2_selection is None or protein_2_selection == "":
            logger.error("protein_2_selection is either None or an empty string.")
            raise exception.IllegalArgumentError("protein_2_selection is either None or an empty string.")
        if (
